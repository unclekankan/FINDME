...
{
  "songA": {"title": "歌名", "artist": "歌手", "year": "年份", "reason": "为什么选这首歌"},
  "songB": {"title": "歌名", "artist": "歌手", "year": "年份", "reason": "为什么选这首歌"},
  "dimension": "本轮维度标签"
}`
...
{
  "score": 数字(1-10),
  "tasteLabel": "品味标签（如：杂食型探索者、主流流行爱好者、独立另类达人、怀旧金曲收藏家……）",
  "summary": "一句话总结（可带调侃）",
  "analysis": "详细分析（2-3段，分析选择模式、偏好倾向、品味深度与广度，语言犀利客观）",
  "strengths": ["优点1", "优点2", "优点3"],
  "weaknesses": ["缺点1", "缺点2"],
  "recommendations": [{"artist": "推荐歌手", "song": "推荐歌曲", "why": "推荐理由"}, ...],
  "musicPersonality": "音乐人格类比"
}`
